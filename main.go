...
//	//user := &User{}
//	//u := User{1, "Tom"}
//	//mValue := u.Test01 // 立即复制 receiver，因为不是指针类型，不受后续修改影响。
//	//u.id, u.name = 2, "Jack"
//	//u.Test01()
//	////u.Test01()
//	//mValue()
...
//	//express(&u)
//
//	//err := openFile("/User/d.text")
//	//switch v := err.(type) {
//	//case *PathError:
//	//	fmt.Printf("error is %s",v)
//	//default:
//	//}
//
...
////		 	op: "read",
////		 	path: "/t",
////		 	createTime: fmt.Sprintf("标记时间%s",time.Now()),
////		 	message: err.Error(),
////		 }
////	}
